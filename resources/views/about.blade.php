            ...
            @foreach ($team as $member)
                ...
                <div class="p-6 text-center bg-[#fff8f0] shadow">
                    ...
                    <div class="flex justify-center space-x-4 text-lg text-black">
                        <a href="{{ $member['social']['instagram'] }}" target="_blank" class="hover:text-gray-600"><i class="fab fa-instagram"></i></a>
                        <a href="https://wa.me/{{ $member['social']['wa'] }}" target="_blank" class="hover:text-gray-600"><i class="fab fa-whatsapp"></i></a>
                        <a href="{{ $member['social']['linkedin'] }}" target="_blank" class="hover:text-gray-600"><i class="fab fa-linkedin-in"></i></a>
                    </div>
                </div>
            @endforeach
        </div>
