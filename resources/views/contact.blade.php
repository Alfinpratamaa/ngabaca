<x-layouts.main title="Contact Us"
    description="Get in touch with our team for any inquiries or support. We're here to help!">
    ...
    <div class="bg-[#fff8f0] font-sans px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        ...
        <div class="max-w-3xl mx-auto text-center mb-12">
            ...
            <p class="mt-4 text-lg text-gray-600">
                Got any questions about the books or scaling on our platform? We're here to help. Chat to our friendly
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-16">
                ...
                <div class="lg:pr-8">
                    <form action="#" method="" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="first-name" id="first-name" placeholder="First name"
                                    class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-[#92400E] focus:border-[#92400E]">
                            </div>
                            <div>
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm bg-white">
                                <div class="absolute inset-y-0 left-0 flex items-center">
                                    <select id="country" name="country"
                                        class="h-full py-0 pl-3 pr-7 border-transparent bg-transparent text-gray-500 focus:outline-none focus:ring-[#92400E] focus:border-[#92400E]">
                                        <option>ID</option>
                                        <option>US</option>
                                        <option>EU</option>
                                    </select>
                                </div>
                                <input type="tel" name="phone-number" id="phone-number" placeholder="+62 (000) 0000"
                                    class="block w-full pl-20 px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-[#92400E] focus:border-[#92400E]">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="message" name="message" rows="4" placeholder="Leave us a message..."
                                class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-[#92400E] focus:border-[#92400E]"></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div class="flex items-center">
                                    <input id="website-design" name="services[]" type="checkbox" value="Website design"
                                        class="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                                    <label for="website-design" class="ml-3 block text-sm text-gray-800">Website
                                        design</label>
                                </div>
                                <div class="flex items-center">
                                    <input id="content-creation" name="services[]" type="checkbox"
                                        value="Content creation"
                                        class="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                                    <label for="content-creation" class="ml-3 block text-sm text-gray-800">Content
                                        creation</label>
                                </div>
                                <div class="flex items-center">
                                    <input id="ux-design" name="services[]" type="checkbox" value="UX design"
                                        class="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                                    <label for="ux-design" class="ml-3 block text-sm text-gray-800">UX design</label>
                                </div>
                                <div class="flex items-center">
                                    <input id="strategy" name="services[]" type="checkbox"
                                        value="Strategy & consulting"
                                        class="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                                    <label for="strategy" class="ml-3 block text-sm text-gray-800">Strategy &
                                        consulting</label>
                                </div>
                                <div class="flex items-center">
                                    <input id="user-research" name="services[]" type="checkbox" value="User research"
                                        class="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                                    <label for="user-research" class="ml-3 block text-sm text-gray-800">User
                                        research</label>
                                </div>
                                <div class="flex items-center">
                                    <input id="other" name="services[]" type="checkbox" value="Other"
                                        class="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                        ...
                        <div>
                            <button type="submit"
                                class="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-secondary bg-primary hover:bg-primary/75 cursor-pointer ">
                                Send message
                            </button>
                        </div>
                    </form>
                ...
                <div class="mt-12 lg:mt-0 space-y-10">
                    ...
                    <div>
                        ...
                        <div class="mt-4 space-y-3">
                            ...
                            <a href="mailto:email@example.com"
                                class="flex items-center text-[#92400E] hover:underline">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <a href="https://x.com/nflzdn_" class="flex items-center text-[#92400E] hover:underline">
                                <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 16 16">
                                    <path
                                        d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-1.78 13h2.683L4.08 2.16H1.31l9.51 11.59Z" />
                                </svg>
                    ...
                    <div>
                        ...
                        <div class="mt-4">
                            <a href="https://maps.google.com/?q=100+Smith+Street,+Collingwood+VIC+3066"
                                target="_blank" rel="noopener noreferrer"
                                class="flex items-start text-[#92400E] hover:underline">
