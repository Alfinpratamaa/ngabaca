                ...
                <flux:field class="w-full">
                    ...
                    <div class="relative">
                        ...
                        <div
                            ...
                            @if ($book_file)
                                <div
                                    class="absolute inset-0 flex items-center justify-center p-6 bg-gradient-to-br from-green-50 to-emerald-50 border-green-300">
                                    <div class="text-center">
                                        <div
                                            class="w-16 h-16 mb-4 mx-auto rounded-2xl bg-gradient-to-br from-green-100 to-emerald-100 flex items-center justify-center">
